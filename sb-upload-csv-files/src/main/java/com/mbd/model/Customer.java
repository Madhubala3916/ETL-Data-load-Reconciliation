...
public class Customer {
    ...
    //@Size(min = 13, max = 13, message = "Contact number must be 13 characters long")@Pattern(regexp = "\\+91 \\d{10}", message = "Invalid contact number format. Must start with +91 and have 10 digits.")
