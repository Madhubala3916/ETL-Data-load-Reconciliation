...
//    @GetMapping("/checkvalidations")
//    public ResponseEntity<String> checkEmailValidation(){
//        try{
//            DataValidator check = new DataValidator();
//            List<Customer> customer1 = fileService.getAllCsvFiles();
//            check.checkCustomerValidation(customer1);
